...
class PageElement:
    ...
    def get_text(
        self, separator: str = ..., strip: bool = ..., types: tuple[type[NavigableString], ...] = ...
    ) -> str: ...
    getText = get_text
    @property
    def text(self) -> str: ...
...
class Tag(PageElement):
    ...
    def encode_contents(
        self, indent_level: int | None = ..., encoding: str = ..., formatter: str | Formatter = ...
    ) -> bytes: ...
    ...
    def select(
        self, selector: str, namespaces: Any | None = ..., limit: int | None = ..., **kwargs: Any
    ) -> ResultSet[Tag]: ...
